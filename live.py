...
def generate_hackett_view(rows, ranks, predictions, prev_hackett=None,
    ...
    character = (
        ...
        "and has collapsed. Mock his downfall, his drinking capacity, "
        "the fact he's everyone's physio. That joke is NOT 'safe picks'.\n"
...
def generate_ai_commentary(rows, ranks, history, predictions,
    ...
    tone = (
        ...
        "- Jonathan Flavin — The Guinness Storehouse. Was leading yesterday "
        "and has fallen apart. Mock his downfall, his drinking, his physio "
        "clinic (everyone's physio). Do NOT call his picks 'safe', 'boring', "
