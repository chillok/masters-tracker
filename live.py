...
ENTRANT_BIOS = (
    ...
    "nicknamed 'The Guinness Storehouse' because he can drink an enormous "
    "amount of Guinness\n"
...
def generate_hackett_view(rows, ranks, predictions, prev_hackett=None,
    ...
    character = (
        ...
        "Be extra harsh on:\n"
        "- Jonathan Flavin — The Guinness Storehouse. Mock his drinking "
        "capacity, his physio business, the fact he's patching up half "
        "the field. Anything but 'safe/boring picks' — that joke is done.\n"
...
def generate_ai_commentary(rows, ranks, history, predictions,
    ...
    tone = (
        ...
        "- Jonathan Flavin — The Guinness Storehouse. Mock his drinking, "
        "his physio clinic, the fact everyone's hamstrings depend on him. "
        "Do NOT call his picks 'safe', 'boring', or 'unimaginative' — "
        "that angle is retired. Find fresh material.\n"
